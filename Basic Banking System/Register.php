  ...
  <body >
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                if (!$conn){
                    ...
                    $sql = "INSERT INTO `arjun`.`arjun` (`ac`, `name`, `email`, `account`, `balance`) VALUES ('$acc','$name', '$email', '$account', '$balance')";
                    ...
                    <strong>Error!</strong> We are facing some technical issue and please enter valid details! We regret the inconvinience caused!
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                    <span class='errorClose' aria-hidden='true'>×</span>
                    </button>
                    </div>";
                    ...
                    <div class="col-lg-7 text-center py5">
                        ...
                        <form action="Register.php" method="post">
                            ...
                            <div class="form-row pt-5 ">
                                <div  class="  offset-1 col-lg-10">
                                    <select  name="account" class="inp px-3 form-selec " aria-label="Default select example" required>
                                        <option value="Current">Select Account Type </option>
							...
							<div class="form-row pt-5 ">
                                <div class="offset-1 col-lg-10">
                                    <input name="ac" type="text" class="inp px-3" placeholder="Enter 12 digit Account Number" required>
                                </div>
                            </div>
